...
const Header = () => {
    ...
    return (
        <header className="dark:bg-black text-white duration-300 bg-blue-950 bg-opacity-95">
            <nav className="container mx-auto px-4 py-3 flex items-center justify-between">
                ...
                <div className="flex items-center">
                    <div className="relative lg:block hidden">
                        <input
                            type="text"
                            className="dark:bg-gray-700 text-black duration-300 dark:text-white px-4 py-1 rounded w-64 outline-none ring-1 ring-gray-200"
            ...
            {/* Offcanvas Menu */}
            <div
                className={`dark:border-2 dark:border-white lg:hidden fixed inset-0 z-10 transition-all duration-300 ${isMenuOpen ? "block" : "hidden"
                    }`}
            >
                <div
                    className="dark:bg-black bg-opacity-50 inset-0 fixed transition-opacity duration-300"
