...
function Sliderbar() {
    ...
    return (
        <>
            ...
            <div className="h-screen fixed lg:w-2/12 w-full sliderBar overflow-scroll dark:text-white dark:bg-dark-black text-black xl:px-4 py-10  border-e-1 dark:border-card-border xl:ps-6 ">
                <div className=' '>
                    ...
                    <ul className="space-y-2">
                        ...
                        <li>
                            ...
                            <ul className={`w-[90%] mx-auto xl:w-full overflow-hidden transition-all bg-white dark:bg-hover-black duration-300 rounded-lg ${isOpen ? 'max-h-48' : 'max-h-0'} ${isOpen ? 'border' : 'border-none'}`} >
                                ...
                                <li onClick={() => getcatdata("SEO")} className="text-sm py-1 px-3 hover:bg-hover-blue hover:text-white dark:hover:bg-gray-700">
                                    <a href="#">
                                        SEO and Finance
                                    </a>
                                </li>
